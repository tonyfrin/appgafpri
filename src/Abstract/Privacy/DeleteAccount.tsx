  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <ol style={{ lineHeight: "1.6" }}>
        <li>
          Abre la aplicación e inicia sesión con tu cuenta.
        </li>
        <li>
          Ve a la sección <strong>"Perfil"</strong>, ubicada en la esquina inferior derecha de la pantalla.
        </li>
        <li>
          Selecciona <strong>"Configuración"</strong>.
        </li>
        <li>
          Desplázate hacia abajo y encontrarás la opción <strong>"Eliminar mi cuenta"</strong>.
        </li>
        <li>
      ...
      <div style={{ marginTop: "2rem", padding: "1.5rem", backgroundColor: "#f9f9f9", border: "1px solid #ddd" }}>
        <h2>Preguntas frecuentes</h2>
        <p><strong>¿Qué sucede después de eliminar mi cuenta?</strong></p>
        <p>
        ...
        <p><strong>¿Cuánto tiempo toma eliminar mi cuenta?</strong></p>
        <p>
