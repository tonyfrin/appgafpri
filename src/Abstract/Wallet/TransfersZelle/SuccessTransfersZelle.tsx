            ...
            >
              <FaCheckCircle style={{
                ...
                <div
                    ...
                    >
                      <h1 style={{textAlign: 'center', padding: '0.3em', fontSize: '0.8em', fontWeight: 400}} className={title1AppStyles}><span style={{fontWeight: 600}}>Importante: </span><span style={{textTransform: 'lowercase'}}>{`La transferencia Zelle está programada ${useWallet.attributesTransfersZelle.states.instructions}`}</span></h1>
                </div>
